...
class multa:
    ...
    def __init__(self):
        ...
        # barra em cima
        self.retangulo = Label(master5, bg='#15803d')
        ...
        # Botões
        self.bt_salvar = Button(master5, text="Salvar", font='arial 10', bg='#15803d', fg="#ffffff")
        ...
        self.bt_cancelar["command"] = home.tela_inicial
