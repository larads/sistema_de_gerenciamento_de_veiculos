...
class fine_database (object):
    ...
    def inserir_multa(self):
            ...
            try:
                connects = database_connection.connection.cursor()

                connects.execute("INSERT INTO multa (cpf,nome,cnh, email,telefone,endereco,cidade,"
